...
<main class="mx-auto max-w-lg px-4 py-8">
	...
	<!-- Default angle -->
	<section class="mb-8">
		<h2 class="mb-1 text-xs font-semibold tracking-wider text-muted uppercase">Default angle</h2>
	...
	<section class="mb-8">
		...
		<div class="space-y-3">
			<div>
				<label for="flash-grade" class="mb-1 block text-xs font-medium text-text">Flash grade</label
				>
